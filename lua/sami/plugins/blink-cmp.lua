    ...
    opts = {
        ...
        keymap = {
            ...
            function(cmp)
                ...
                --]]
                function(cmp)
                    --vim.notify("mode: " .. vim.json.encode(vim.api.nvim_get_mode()))
                    if vim.api.nvim_get_mode().mode == "i" and has_words_before() then
                ...
                draw = {
                    ...
                    components = {
                        label = {
                            width = { fill = true },
                            text = function(ctx)
                                ctx.label = trim(ctx.label)
                                ctx.item.label = trim(ctx.item.label)
